/* ═══════════════════════════════════════════════════════════════
   VARIABLES GLOBALES
   Guardamos aquí todos los datos que la página necesita recordar
   mientras el usuario la usa.
════════════════════════════════════════════════════════════════ */

// Dirección de la API de donde vamos a traer los productos
var UrlApi = "https://dummyjson.com/products?limit=0";

// Array (lista) con todos los productos que trae la API
var Productos = [];

// Array con las categorías encontradas y cuántos productos tiene cada una
var Categorias = [];

// Array con los nombres de las categorías que el usuario tildó
var CategoriasSeleccionadas = [];

// Indica qué se está mostrando en el pantalla central: 'catalogo' o 'carrito'
var ModoVista = 'catalogo';

// Array con los productos que el usuario agregó al carrito.
// Cada elemento es un objeto: { producto: {...}, cantidad: 2 }
var Carrito = [];

// Nombre de la "casilla" que usamos para guardar el carrito en localStorage
var CLAVE_CARRITO_EN_LOCALSTORAGE = "catalogo-carrito";
